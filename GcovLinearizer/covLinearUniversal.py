...
# Requirement:
#   1. the unit test's info file is named as z_self*.info
#
##############################
...
# get statistical info of overall coverage of all packages, excluding unit test
...
for infoFile in infoList:
    ...
    for sourcefile in sourceList:
        for line in sourceList[sourcefile]:
            key = (sourcefile, line)

            val = sourceList[sourcefile][line] # overall hitting times
            if val != 0:
                counter = 1 # whether this line is hitten by this infoFile
            else:
                counter = 0
...
for infoFile in infoList:
    ...
    for sourcefile in sourceList:
        for funName in sourceList[sourcefile]:
            key = (sourcefile, funName)

            val = sourceList[sourcefile][funName] # overall hitting times
            if val != 0:
                counter = 1 # whether this line is hitten by this infoFile
            else:
                counter = 0
...
for infoFile in infoList:
    ...
    for sourcefile in sourceList:
        for brName in sourceList[sourcefile]:
            key = (sourcefile, brName)

            val = sourceList[sourcefile][brName] # overall hitting times
            if val != 0:
                counter = 1 # whether this line is hitten by this infoFile
            else:
                counter = 0
